...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    @Query("select c from Task c where (:title is null or :title='' or lower(c.title) like lower(concat( '%', :title, '%' ) ) ) and" +
    ...
    public List<Task> findByParams(@Param("title") String title, @Param("completed")Integer completed,
                                                                       @Param("priority") Long priorityId, @Param("category")Long categoryId);
